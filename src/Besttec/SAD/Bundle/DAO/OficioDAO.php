...
class OficioDAO
{
    ...
    public function getOficios() 
    {
        try {
            ...
            $query = $this->manager->createQuery("SELECT o FROM BesttecSADBundle:Oficios o");
    ...
    public function getOficio($numOficio)
    {
        try {
            ...
            $query = $this->manager->createQuery("SELECT o FROM BesttecSADBundle:Oficios o WHERE o.numOficio = :num")
                    ->setParameter(":num", $numOficio);
            $oficio = $query->getResult();
            return $oficio;
