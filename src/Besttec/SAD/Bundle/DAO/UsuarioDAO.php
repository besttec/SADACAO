    ...
    */
    ...
    public function getUsuarios()
    {
        try {
            ...
            $this->manager->createQuery("SELECT u FROM BesttecSADBundle u");
            $usuarios = $this->getResult();
            return $usuarios;
    ...
    public function getUsuario($id) 
    {
        try {
            ...
            $this->manager->createQuery("SELECT u FROM BesttecSADBundle u WHERE u.idUsuario = :id")
                    ->setParameter(":id", $id);
